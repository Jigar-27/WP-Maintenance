...
.im-concierge .material-icons-outlined { font-size: 1.05rem; color: #9b7a2f; }
...
.im-period-select {
    ...
    font-weight: 800;
    border-radius: 10px;
    padding: 0.56rem 2rem 0.56rem 0.74rem;
    min-width: 140px;
    appearance: none;
    -webkit-appearance: none;
    -moz-appearance: none;
    background-image: linear-gradient(45deg, transparent 50%, #6f778f 50%), linear-gradient(135deg, #6f778f 50%, transparent 50%);
    background-position: calc(100% - 16px) calc(50% - 2px), calc(100% - 10px) calc(50% - 2px);
    background-size: 6px 6px, 6px 6px;
    background-repeat: no-repeat;
}
.im-period-select:focus {
    outline: none;
    border-color: #d8deec;
}
...
.im-bar.active { background: #f0612f; }
.im-bar-label {
    margin-top: 0.5rem;
    text-align: center;
    font-size: 0.66rem;
...
.im-kpi.primary { border-left: 3px solid #f0612f; }
.im-kpi-label {
    font-size: 0.66rem;
...
.im-kpi-value-row { display: flex; align-items: baseline; justify-content: space-between; gap: 0.4rem; }
.im-kpi-value {
    font-size: 2.25rem;
    line-height: 1;
    color: #1f2b45;
...
.im-kpi-growth .material-icons-outlined { font-size: 0.95rem; }
.im-kpi-avatars { display: inline-flex; align-items: center; }
.im-kpi-avatars img {
    width: 19px;
    height: 19px;
    border-radius: 50%;
...
.im-kpi-avatars img:first-child { margin-left: 0; }
.im-kpi-avatars span {
    margin-left: 0.24rem;
    font-size: 0.68rem;
    color: #6f7690;
...
.im-client { font-weight: 900; color: #1f2b45; }
.im-domain { color: #7f879b; font-weight: 600; }
.im-price-pill {
    display: inline-flex;
    align-items: center;
...
.im-renew { color: #69708b; font-weight: 700; white-space: nowrap; }

.im-dues-card {
    background: linear-gradient(165deg, #141b31 0%, #0c1222 60%, #1a1726 100%);
    color: #fff;
    border-radius: 14px;
...
.im-dues-head .material-icons-outlined { font-size: 1rem; color: #ff8a4b; }
...
.im-due-item:last-child { margin-bottom: 0; }
.im-due-name { font-weight: 900; font-size: 0.95rem; }
.im-due-sub { font-size: 0.68rem; color: rgba(255,255,255,0.52); font-weight: 700; margin-top: 0.1rem; }
.im-due-amount { font-weight: 900; font-size: 1.2rem; color: #ff8a4b; text-align: right; }
.im-due-method { font-size: 0.6rem; color: rgba(255,255,255,0.5); text-align: right; font-weight: 900; margin-top: 0.15rem; text-transform: uppercase; }
...
.im-dues-link:hover { background: rgba(255,255,255,0.08); color: #fff; }
        ...
        <div class="im-card im-table-card">
            ...
            <table class="im-table" data-yajra="1">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" style="text-align:center;color:#98a0b5;font-weight:700;padding:1.3rem;">No active subscriptions yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
